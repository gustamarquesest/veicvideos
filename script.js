const SITE_ASSET_VERSION = "20260610-avante-thumb";

const desktopSafeYoutubeThumbs = {
  AVlMyYiXCCk: "https://i.ytimg.com/vi/AVlMyYiXCCk/sddefault.jpg",
};
...
function autoThumbUrl(video) {
  ...
  if (desktopSafeYoutubeThumbs[video.id]) return desktopSafeYoutubeThumbs[video.id];
...
function thumbSrcset(video) {
  ...
  if (desktopSafeYoutubeThumbs[video.id]) return "";
  if (video.p === "vimeo") {
