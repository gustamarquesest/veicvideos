...
function openVideo({ id, platform, orientation, title, sound = false }) {
  ...
  const src = isVimeo
    ? `https://player.vimeo.com/video/${id}?autoplay=1&badge=0&autopause=0&muted=0#t=0s`
    : `https://www.youtube.com/embed/${id}?autoplay=1&mute=0&enablejsapi=1&rel=0&modestbranding=1&playsinline=1&vq=hd1080&hd=1&quality=hd1080`;
